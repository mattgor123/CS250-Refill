...
/**
 * This Receiver class is used for sending notification to phone http://stackoverflow
 * .com/questions/9930683/android-notification-at-specific-date
 */
public class RxNotificationManager extends BroadcastReceiver {
  ...
  public void makeNotificationShouldUpdateRx(Context c, RxItem r) {
    ...
    NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(c); // Null
    // pointers
    // for
    // days?
