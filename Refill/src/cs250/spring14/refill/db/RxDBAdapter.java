...
public class RxDBAdapter {
	...
	public static final String[] RX_COLS = { RX_ID, RX_NAME, RX_PT, RX_SYMPT,
	...
	private static class RxdbHelper extends SQLiteOpenHelper {
		...
		private static final String DB_CREATE = "CREATE TABLE " + RX_TABLE
				...
				+ RX_NAME + " TEXT," + RX_PT + " TEXT," + RX_SYMPT + " TEXT,"
				+ RX_SFECT + " TEXT," + RX_DOSE + " REAL," + RX_PRD
				+ " INTEGER," + RX_DBR + " INTEGER, " + RX_PHRM + " TEXT,"
				+ RX_MD + " TEXT, " + RX_NMB + " TEXT," + RX_STD + " TEXT, "
				+ RX_LAST + " TEXT);";

		public RxdbHelper(Context context, String name, CursorFactory fct,
				int version) {
